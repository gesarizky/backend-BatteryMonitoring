...
import Talis5 from "./Settings.js";

/**
 * @description tabel database
 */

const Talis5Realtime = DB.define("realtime_talis5", {
  pcb_barcode: {
...
Talis5.hasMany(Talis5Realtime, { foreignKey: "talis_id", onDelete: "CASCADE" });
Talis5Realtime.belongsTo(Talis5, { foreignKey: "talis_id" });

export default Talis5Realtime;
